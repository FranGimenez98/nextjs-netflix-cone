...
const Banner = ({ netflixOriginals }: Props) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center space-y-2 py-16 md:space-y-4 lg:h-[70vh] lg:justify-end lg:pb-12">
      ...
      <h1 className="tex-2xl md:text-4xl lg:text-7xl font-bold">
        {movie?.title || movie?.name || movie?.original_name}
      </h1>
      <p className="text-shadow-md max-w-xs text-xs md:max-w-lg md:text-lg ">
        {movie?.overview}
      </p>
